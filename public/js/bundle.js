...
var updateBook = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(name, author, id) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
  ...
  return function updateBook(_x, _x2, _x3) {
    return _ref.apply(this, arguments);
  };
}();
...
var bookForm = document.querySelector('.form-book-data');
...
if (newsletterForm) newsletterForm.addEventListener('submit', function (e) {
  ...
  var email = document.getElementById('email').value;
  console.log(email, name); // login(email, password);
});
...
if (bookForm) bookForm.addEventListener('submit', function (e) {
  ...
  (0, _manageRessources.updateBook)(name, author, id);
});
