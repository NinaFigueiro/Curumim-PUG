      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _alerts.showAlert)('error', 'Error loogging out! Try again.');
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"manageRessources.js":[function(require,module,exports) {
"use strict";
...
var updateBook = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: "http://127.0.0.1:8000/api/v1/books/".concat(id),
              id: id,
              data: data
            });
  ...
  return function updateBook(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
...
var _manageRessources = require("./manageRessources");
...
var bookDataForm = document.querySelector('.form-book-data');
var userDataForm = document.querySelector('.form-user-data');
var userPasswordForm = document.querySelector('.form-user-password');
var logOutBtn = document.querySelector('.nav__el--logout');
var newsletterForm = document.querySelector('.form--newsletter'); // VALUES
// DELEGATION
...
if (newsletterForm) newsletterForm.addEventListener('submit', function (e) {
  ...
  var email = document.getElementById('email').value; // login(email, password);
});
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            passwordConfirm = document.getElementById('password-confirm').value; // We use await so we only execute the rest of the code after the function is finished
